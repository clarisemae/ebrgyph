// Function to sort the Certificate of Indigency table based on dropdown selection
    ...
    rows.sort((a, b) => {
        ...
        switch (criteria) {
            ...
            case 'date':
                ...
                break;
            case 'purpose':
                aValue = a.cells[9].textContent.trim(); // Purpose column
    ...
    document.getElementById('search-certificates').addEventListener('input', function () {
        ...
        if (!isAnyRowVisible) {
            if (!document.getElementById('no-records')) {
                ...
                noRecordsRow.innerHTML = `<td colspan="13" style="text-align: center;">No records found</td>`;
