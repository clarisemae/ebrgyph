...
<head>
  ...
  <title>Certificate of Non-Residency Records</title>
...
<body>
  ...
  <main class="main-container">
      <h1>
        ...
        <span class="current-page">Certificate of Non-Residency Records</span>
      </h1>
    ...
    <table class="certificate-table table-bordered">
      ...
      <tbody id="certificate-table-body">
        <?php if (!empty($certificate_of_non_residency)): ?>
          <?php foreach ($certificate_of_non_residency as $record): ?>
            <tr>
              ...
              <td><?= htmlspecialchars($record['non_residency_purpose'] ?: 'N/A') ?></td>
              ...
              <td>
                <?php if (!empty($record['id_photo_url'])): ?>
                  <img src="crudNonResidency/uploads/<?= htmlspecialchars($record['id_photo_url']) ?>" 
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="addRecordModalLabel">Add New Certificate of Non-Residency</h5>
        ...
        <form id="addRecordForm">
          ...
          <div class="mb-3">
            ...
            <select id="document_type" name="document_type" class="form-select" required>
              <option value="Non-Residency Certificate">Non-Residency Certificate</option>
            </select>
          </div>
          ...
          <!-- Non-Residency Purpose -->
          <div class="mb-3">
            <label for="non_residency_purpose" class="form-label">Non-Residency Purpose:</label>
            <textarea id="non_residency_purpose" name="non_residency_purpose" class="form-control" rows="3" placeholder="Enter purpose" required></textarea>
          </div>
...
<div class="modal fade" id="editRecordModal" tabindex="-1" aria-labelledby="editRecordModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editRecordModalLabel">Edit Certificate of Non-Residency</h5>
            ...
            <div class="modal-body">
                <form id="editRecordForm" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        <label for="edit_non_residency_purpose" class="form-label">Purpose:</label>
                        <textarea id="edit_non_residency_purpose" name="non_residency_purpose" class="form-control" rows="2" required></textarea>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" id="edit_subject_fullname" name="subject_fullname" class="form-control">
                    </div>
                    <div class="mb-3">
                        <label for="edit_subject_dob" class="form-label">Subject Date of Birth:</label>
                        <input type="date" id="edit_subject_dob" name="subject_dob" class="form-control">
                    </div>
                    <div class="mb-3">
                        <label for="edit_subject_age" class="form-label">Subject Age:</label>
                        <input type="number" id="edit_subject_age" name="subject_age" class="form-control">
                    </div>
                    <div class="text-end">
...
<script src="crudNonResidency/sort.js"></script>
<script src="crudNonResidency/fetch_cert.js"></script>
<script src="crudNonResidency/add_cert.js"></script>
<script src="crudNonResidency/delete_cert.js"></script>
<script src="crudNonResidency/print_cert.js"></script>
<script src="crudNonResidency/update_cert.js"></script>
</body>
</html>
