...
$sql = "SELECT * FROM certificate_of_indigency WHERE id = ?";
...
$requirements = array_map('trim', explode(',', $document['indigency_purpose']));
...
<head>
    ...
    <link rel="stylesheet" href="../css/cert_css/cert_indigency.css">
        ...
        <div class="officials">
            ...
            <div class="content-text">
                ...
                <p>This is to certify that <strong><?=htmlspecialchars($document['fullname']); ?></strong>,<strong><?=htmlspecialchars($document['age']); ?></strong>,
                    ...
                    of this barangay with postal address at <strong><?=htmlspecialchars($document['address']); ?></strong> and belongs to the indigent family in this baranggay.</p>
                </div>
                ...
                <div class="checklist">
                    <p><strong>[ <?= in_array('Financial Assistance', $requirements) ? 'X' : ' ' ?> ]</strong> Financial Assistance</p>
                    <p><strong>[ <?= in_array('Medical Assistance', $requirements) ? 'X' : ' ' ?> ]</strong> Medical Assistance</p>
                    <p><strong>[ <?= in_array('Educational Assistance', $requirements) ? 'X' : ' ' ?> ]</strong> Educational Assistance</p>
                    <p><strong>[ <?= in_array('Burial Assistance', $requirements) ? 'X' : ' ' ?> ]</strong> Burial Assistance</p>
                    <p><strong>[ <?= in_array('Livelihood Assistance', $requirements) ? 'X' : ' ' ?> ]</strong> Livelihood Assistance</p>
